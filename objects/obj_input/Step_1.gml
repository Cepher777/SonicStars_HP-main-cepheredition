/// @description Input checks	
	if(instance_exists(obj_shell) && !obj_shell.isOpen || !instance_exists(obj_shell))
	{
		...
		Y = keyboard_check(global.y) || gamepad_button_check(global.gamepad_slot, gp_face4);
		Action = A || B || C;
		...
		YPress = keyboard_check_pressed(global.y) || gamepad_button_check_pressed(global.gamepad_slot, gp_face4);
