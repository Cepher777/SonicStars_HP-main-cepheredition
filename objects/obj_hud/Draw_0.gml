/// @description Draw the HUD
	...
	//Draw life icon
	if(obj_player.transform_timer != 0) palette_swap_smooth(spr_pal_characters, ((global.object_timer/24 mod 2)*floor(obj_player.transform_timer/50) + obj_player.transform_timer/50))
	...
	//Draw number
	draw_text(120 + offset[0], 12, string(global.score));
	draw_text(128 + offset[1], 28, string(minute)+" "+(sec > 9 ? "" : "0") + string(sec)+" "+(milsec > 9 ? "" : "0") + string(milsec));
	draw_text(104 + offset[2], 44, string(global.rings));
