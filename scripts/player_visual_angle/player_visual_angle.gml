function player_visual_angle(){
	...
	if (character == CHAR_ESPIO){
		if(!animation_is_playing(animator, ANIM_WALK) && !animation_is_playing(animator, ANIM_ROLL) && !animation_is_playing(animator, ANIM_RUN) && !animation_is_playing(animator, ANIM_MAXRUN))
		{
			visual_angle = 0;
		}
	}
