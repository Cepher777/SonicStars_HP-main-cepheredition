function draw_background_layer(background_layer)
{
	...
	if(line_scroll[background_layer] = false)
	{
		...
		if (visibility[background_layer] == true) draw_sprite_tiled_horizontal(background_sprite[background_layer], background_frame[background_layer], floor(pos_x[background_layer]), floor(pos_y[background_layer]), background_vertical[background_layer]);
	}else
	{
		if(trigger[background_layer])
		{
		...
		if (visibility[background_layer] == true) draw_sprite_ext(background_sprite[background_layer], background_frame[background_layer], camera_get_view_x(view_camera[view_current]), floor(pos_y[background_layer]) , 1, bg_scale[background_layer], 0, c_white, 1);
	}
	shader_reset();
}