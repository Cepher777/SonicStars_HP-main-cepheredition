function player_hitbox(){
	...
	//Forceroll hitboxes
	if(animation_is_playing(animator, ANIM_FORCEROLL))
	{
		//Change the camera offset for rolling
		if(ground || landed)
		{
		...
		//Change the hitbox for forcerolling animation
		hitbox_w = hitbox_forcerolling[global.character][0];
		hitbox_h = hitbox_forcerolling[global.character][1];
	}
