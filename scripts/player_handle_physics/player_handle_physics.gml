function player_handle_physics(){
	...
	var physics_table =
	{
		accel : [0.046875, 0.046875, 0.046875, 0.046875, 0.046875, 0.046875],
		fric : [0.046875, 0.046875, 0.046875, 0.046875, 0.046875, 0.046875],
		grav : [0.21875, 0.21875, 0.21875, 0.21875, 0.21875, 0.21875],
		top_speed : [6.0, 6.0, 6.0, 6.0, 6.0, 6.0],
		jump_strength : [6.5, 6.5, 6.0, 6.5, 6.5, 6.5],
		jump_release : [4.0, 4.0, 4.0, 4.0, 4.0, 4.0],
		slope_up : [0.078125, 0.078125, 0.078125, 0.078125, 0.078125, 0.078125],
		slope_down : [0.3125, 0.3125, 0.3125, 0.3125, 0.3125, 0.3125]
	};
	...
	if(state != ST_TAILSFLY) && (state != ST_HAMMERFLY)
	{
		//Apply the gravity
	...
	if(speed_shoes_flag && !super_state) 
	{
        top_speed *= 2.0;
        x_accel *= 2.0;
    }
